...
class Dispatcher
{
    ...
    private function dispatch()
    {
        ...
        if (isset($this->routeList[$this->currentRequest->getRoute()])) {
            //Aqui dentro tenetemos un texto del tipo AEV1\Controller\DetalleController
            $controllerClass = "AEV1\\Controllers\\" . $this->routeList[$this->currentRequest->getRoute()]["controller"];
            //Es equivalente a $controller = new AEV1\Controller\MainController o DetalleController;
